...
OUTDIR      = "/Users/prerit/Physics/100TeV/Data/t~t~/" # Directory where root output files will be stored (temporrarily if sending to remote machine)
SlhaFile    = "/Users/prerit/Physics/100TeV/Stops/Cards/default.slha" # default slha file with path included
PythiaCMND  = "/Users/prerit/Physics/100TeV/Stops/Cards/default.cmnd" # default command file for Pythia run with path included
